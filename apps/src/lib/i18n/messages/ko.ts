...
export const KO_MESSAGES: MessageCatalog = {
  ...
  "未配置上传测试接口。请在系统设置或环境变量中设置 CODEXMANAGER_PROXY_TEST_UPLOAD_URL。":
    "업로드 테스트 엔드포인트가 구성되지 않았습니다. 시스템 설정 또는 환경 변수에서 CODEXMANAGER_PROXY_TEST_UPLOAD_URL을 설정하세요.",
  "Cloudflare-style": "Cloudflare 스타일",
  "Download": "다운로드",
  "Upload": "업로드",
  "Legacy": "일반 (Legacy)",
  "Test preset": "테스트 프리셋",
  "Select preset...": "프리셋 선택...",
  "Tiny (100KB)": "매우 빠름 (Tiny) - 100KB",
  "Quick (1MB)": "빠름 (Quick) - 1MB",
  "Normal (25MB)": "일반 (Normal) - 25MB",
  "Deep (100MB)": "깊음 (Deep) - 100MB",
  "延迟测试中": "지연 시간 테스트 중...",
  "下载测试中": "다운로드 테스트 중...",
  "上传测试中": "업로드 테스트 중...",
  "保存结果中": "결과 저장 중...",
  ...
  "低于保留百分比的账号会从网关路由候选中跳过。":
    "보존 비율 아래의 계정은 게이트웨이 라우팅 후보에서 제외됩니다.",
  "5 小时窗口保留 (%)": "5시간 창 보존 (%)",
  "周窗口保留 (%)": "주간 창 보존 (%)",
  ...
  归属成员: "소유 멤버",
  "代理设置": "프록시 설정",
  "管理可复用的代理配置，为账号或网关提供代理能力。": "계정 또는 게이트웨이를 위한 재사용 가능한 프록시 프로필 관리.",
  "个配置": "개 프로필",
  "添加代理": "프록시 추가",
  "当前运行环境不支持代理配置管理。": "현재 런타임에서는 프록시 프로필 관리를 사용할 수 없습니다.",
  "搜索名称、端点、主机或标签": "이름, 엔드포인트, 호스트 또는 태그 검색",
  "暂无代理配置": "아직 프록시 프로필이 없습니다",
  "没有匹配的代理": "일치하는 프록시 없음",
  "创建第一个代理配置，以便在系统设置中路由和跟踪端点健康状况。": "라우팅 및 엔드포인트 상태 추적을 위해 첫 번째 프록시 프로필을 만드세요.",
  "调整当前搜索或过滤选项以查看更多代理配置。": "현재 검색 또는 필터를 조정하여 더 많은 프로필을 확인하세요.",
  "测试链接": "테스트 URL",
  "测试链接设置会应用到当前列表中的所有代理测试操作。": "이 설정은 현재 목록의 모든 프록시 테스트 실행에 적용됩니다.",
  "选择测试链接": "테스트 URL 선택",
  "自定义 URL": "사용자 지정 URL",
  "请输入自定义 URL": "사용자 지정 URL을 입력하세요",
  "加载测试目标失败:": "테스트 대상 로드 실패:",
  "该测试目标可能被网络门户或重定向拦截。": "이 대상은 캡티브 포털이나 리다이렉트에 가로채질 수 있습니다.",
  "旧版 / 有风险": "레거시 / 위험",
  "连通性延迟": "지연 시간",
  "健康": "정상",
  "检查中": "확인 중",
  "保存用于系统级路由和诊断的代理配置。": "라우팅 및 진단을 위한 재사용 가능한 프록시 프로필 저장.",
  "禁用的配置会保留在列表中，以后可以重新启用。": "비활성화된 프로필은 목록에 유지되며 나중에 다시 활성화할 수 있습니다.",
  "代理 URL": "프록시 URL",
  "留空以保持当前端点不变。": "현재 엔드포인트를 유지하려면 비워두세요.",
  "凭据以密文形式存储在后端，列表视图仅显示脱敏后的端点。": "자격 증명은 백엔드에 암호화되어 저장되며 목록에는 수정된 엔드포인트가 표시됩니다.",
  "边缘中继": "에지 릴레이",
  "加载失败:": "로드 실패:",
};
