...
export const KO_ACCOUNTS_MESSAGES: MessageCatalog = {
  ...
  "预计删除": "예상 삭제",
  免费重置: "무료 재설정",
  "查询免费重置次数失败": "무료 재설정 횟수 조회 실패",
  "免费重置失败": "무료 재설정 실패",
  "免费重置已触发，账号用量已刷新":
    "무료 재설정이 트리거되었으며 계정 사용량이 새로 고침되었습니다.",
  "当前账号没有可用免费重置":
    "이 계정에는 사용 가능한 무료 재설정이 없습니다.",
  "已取消免费重置": "무료 재설정이 취소되었습니다",
  "当前账号有 {count} 次免费重置可用，确定消耗 1 次并刷新用量吗？":
    "이 계정에는 {count}회 무료 재설정을 사용할 수 있습니다. 1회 소모하고 사용량을 새로 고치시겠습니까?",
  "触发免费重置": "무료 재설정 트리거",
};
