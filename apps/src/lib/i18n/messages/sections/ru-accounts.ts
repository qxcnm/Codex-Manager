...
export const RU_ACCOUNTS_MESSAGES: MessageCatalog = {
  ...
  免费重置: "Бесплатный сброс",
  "查询免费重置次数失败": "Не удалось получить количество бесплатных сбросов",
  "免费重置失败": "Не удалось выполнить бесплатный сброс",
  "免费重置已触发，账号用量已刷新":
    "Бесплатный сброс запущен, использование аккаунта обновлено.",
  "当前账号没有可用免费重置":
    "У этого аккаунта нет доступных бесплатных сбросов.",
  "已取消免费重置": "Бесплатный сброс отменён",
  "当前账号有 {count} 次免费重置可用，确定消耗 1 次并刷新用量吗？":
    "У этого аккаунта доступно {count} бесплатных сбросов. Потратить 1 и обновить использование?",
  "触发免费重置": "Запустить бесплатный сброс",
};
