...
"个人资料已更新": "Profile updated",
  ...
  归属成员: "Owner member",
  "代理设置": "Proxy settings",
  "管理可复用的代理配置，为账号或网关提供代理能力。": "Manage reusable proxy profiles for accounts or gateway.",
  "个配置": "profiles",
  "添加代理": "Add proxy",
  "当前运行环境不支持代理配置管理。": "Proxy profile management is unavailable in the current runtime.",
  "搜索名称、端点、主机或标签": "Search name, endpoint, host, or tag",
  "暂无代理配置": "No proxy profiles yet",
  "没有匹配的代理": "No matching proxies",
  "创建第一个代理配置，以便在系统设置中路由和跟踪端点健康状况。": "Create the first proxy profile to start routing and tracking endpoint health.",
  "调整当前搜索或过滤选项以查看更多代理配置。": "Adjust the current search or filter selection to see more proxy profiles.",
  "测试链接": "Test URL",
  "测试链接设置会应用到当前列表中的所有代理测试操作。": "This setting applies to every proxy test run in the current list.",
  "选择测试链接": "Select test URL",
  "自定义 URL": "Custom URL",
  "请输入自定义 URL": "Enter a custom URL",
  "加载测试目标失败:": "Failed to load test targets:",
  "该测试目标可能被网络门户或重定向拦截。": "This target may be intercepted by captive portals or redirects.",
  "旧版 / 有风险": "Legacy / risky",
  "连通性延迟": "URL-test latency",
  "健康": "Healthy",
  "检查中": "Checking",
  "保存用于系统级路由和诊断的代理配置。": "Save reusable proxy profiles for routing and diagnostics.",
  "禁用的配置会保留在列表中，以后可以重新启用。": "Disabled profiles stay in the registry and can be re-enabled later.",
  "代理 URL": "Proxy URL",
  "留空以保持当前端点不变。": "Leave empty to keep current endpoint.",
  "凭据以密文形式存储在后端，列表视图仅显示脱敏后的端点。": "Credentials are encrypted in backend, list shows redacted endpoint.",
  "边缘中继": "Edge relay",
  "加载失败:": "Failed to load:",
};
